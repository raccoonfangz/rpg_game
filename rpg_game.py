...
def combat_mechanic():
    ...
    while opponent["Health"] > 0:
        ...
        if choice == "1" or choice == "attack":  # Attack
            ...
            difficulty = calculate_difficulty()
            # opponent special effects handling
            ...
            # Apply status effects after enemy attacks
            ...
            # Apply status effects after defending
            if game_state.get("BLEEDING"):
                game_state["PLAYER_HEALTH"] -= 5
...
def meta_shop():
    ...
    print(f"{'2.':<3} {'High stakes - bet cap raised to 1,000,000':<40} {'100p':>10}")
